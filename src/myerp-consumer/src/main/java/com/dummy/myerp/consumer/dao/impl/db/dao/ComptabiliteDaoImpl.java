...
public class ComptabiliteDaoImpl extends AbstractDbConsumer implements ComptabiliteDao {
    ...
    private static JdbcTemplate vJdbcTemplate = new JdbcTemplate();

    public void setJdbcTemplate(JdbcTemplate pJdbcTemplate) {
        this.vJdbcTemplate = pJdbcTemplate;
    }


    private static NamedParameterJdbcTemplate vNamedParameterJdbcTemplate = null;

    public void setNamedParameterJdbcTemplate(NamedParameterJdbcTemplate pNamedParameterJdbcTemplate) {
        this.vNamedParameterJdbcTemplate = pNamedParameterJdbcTemplate;
    }
    ...
    public List<CompteComptable> getListCompteComptable() {
        ...
        JdbcTemplate vJdbcTemplate = this.vJdbcTemplate;
    ...
    public EcritureComptable getEcritureComptable(Integer pId) throws NotFoundException {
       ...
       if(vJdbcTemplate == null) vJdbcTemplate = new NamedParameterJdbcTemplate(getDataSource(DataSourcesEnum.MYERP));
        ...
        try {
            vBean = vJdbcTemplate.queryForObject(SQLgetEcritureComptable, vSqlParams, new EcritureComptableRM());

        } catch (EmptyResultDataAccessException vEx) {

            String exceptionMsg = "EcritureComptable non trouvée : id=" + pId;
    ...
    public EcritureComptable getEcritureComptableByRef(String pReference) throws NotFoundException {
        ...
        EcritureComptable vBean;
        try {
            vBean = vJdbcTemplate.queryForObject(SQLgetEcritureComptableByRef, vSqlParams, new EcritureComptableRM());

        } catch (EmptyResultDataAccessException vEx) {

            String exceptionMsg = "EcritureComptable non trouvée : reference=" + pReference;
            LOGGER.error(vEx.toString() + " | " + exceptionMsg);
    ...
    public void loadListLigneEcriture(EcritureComptable pEcritureComptable) {
        ...
        List<LigneEcritureComptable> vList = vJdbcTemplate.query(SQLloadListLigneEcriture, vSqlParams, new LigneEcritureComptableRM());
    ...
    // when() => Les méthodes de abstractConsumer ? => this.queryGetSequence
    ...
    public void insertEcritureComptable(EcritureComptable pEcritureComptable) {
        ...
        // ===== Ecriture Comptable
        NamedParameterJdbcTemplate nJdbcTemplate = vNamedParameterJdbcTemplate;
        if(nJdbcTemplate == null) nJdbcTemplate = new NamedParameterJdbcTemplate(getDataSource(DataSourcesEnum.MYERP));
        ...
        nJdbcTemplate.update(SQLinsertEcritureComptable, vSqlParams);


        // ----- Récupération de l'id
        // ===== Liste des lignes d'écriture
        Integer vId = this.queryGetSequenceValuePostgreSQL(vJdbcTemplate, "myerp.ecriture_comptable_id_seq", Integer.class);
    ...
    @Override
    public void updateSequenceEcritureComptable(SequenceEcritureComptable sequenceEcritureComptable, String journalCode) {
    ...
    @Override
    public void insertSequenceEcritureComptable(SequenceEcritureComptable sequenceEcritureComptable, String journalCode) {
